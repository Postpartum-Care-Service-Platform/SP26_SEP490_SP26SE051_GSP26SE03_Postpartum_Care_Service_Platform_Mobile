...
class AppStrings {
  ...
  static const String noTransactionsFound = 'Không tìm thấy giao dịch nào';
  static const String noTransactionsYet = 'Chưa có giao dịch nào';
  static const String recent = 'Gần đây';
  static const String searchHintTransaction = 'Tìm theo tên, mã giao dịch...';
  static const String advancedFilter = 'Bộ lọc nâng cao';
  ...
  static const String timeRange = 'Khoảng thời gian';
  static const String selectBankApp = 'Chọn ứng dụng Ngân hàng';
  static const String noBankAppsFound = 'Không tìm thấy ứng dụng ngân hàng nào hỗ trợ';
  static const String tryAgain = 'Thử lại';
  static const String cancelAction = 'Hủy';
  static const String sendAction = 'Gửi';
  static const String closeAction = 'Đóng';
  static const String deleteAction = 'Xóa';
  static const String confirmAction = 'Xác nhận';
  static const String saveAction = 'Lưu';
  static const String platformCommission = 'Hoa hồng hệ thống';
  static const String statusPendingAction = 'Chờ xử lý';
  static const String transactionTypeFull = 'Thanh toán toàn bộ';
  static const String createSwapRequest = 'Tạo yêu cầu đổi lịch';
  static const String swapReason = 'Lý do đổi lịch';
  static const String swapRequestSent = 'Đã gửi yêu cầu đổi lịch.';
  static const String swapRequestFailed = 'Tạo yêu cầu thất bại';
  static const String selectCurrentSchedule = 'Chọn lịch hiện tại';
  static const String noSchedulesToSelect = 'Không có lịch để chọn.';
  static const String selectTargetSchedule = 'Chọn lịch muốn đổi';
  static const String noStaffToSelect = 'Không có nhân viên để chọn.';
  static const String selectReceiver = 'Chọn người nhận yêu cầu';
  static const String requestAccepted = 'Đã chấp nhận yêu cầu.';
  static const String requestRejected = 'Đã từ chối yêu cầu.';
  static const String processRequestFailed = 'Xử lý yêu cầu thất bại';
  static const String swapRequestTitle = 'Yêu cầu đổi lịch 🔁';
  static const String swapRequestSubtitle = 'Gửi / nhận yêu cầu đổi ca giữa nhân viên';
  static const String tabSent = 'Đã gửi';
  static const String tabReceived = 'Đã nhận';
  static const String filterByDateOptional = 'Lọc theo ngày (tùy chọn)';
  static const String clearDateFilter = 'Xóa lọc ngày';
  static const String processing = 'Đang xử lý...';
  static const String loadDataError = 'Không tải được dữ liệu';
  static const String noRequestsInTimeRange = 'Chưa có yêu cầu nào trong phạm vi thời gian này.';
  static const String currentSchedulePrefix = 'Lịch hiện tại';
  static const String targetSchedulePrefix = 'Lịch muốn đổi';
  static const String reasonPrefix = 'Lý do';
  static const String createdAtPrefix = 'Tạo lúc';
  static const String noneValue = '(Không có)';
  static const String datePrefix = 'Ngày';
  static const String familyTitle = 'Gia đình';
  static const String contractTitle = 'Hợp đồng';
  static const String amenityTitle = 'Tiện ích';
  static const String myBookingTitle = 'Booking của tôi';
  static const String feedbackTitle = 'Phản hồi';
